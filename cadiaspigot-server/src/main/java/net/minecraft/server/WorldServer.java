...
public class WorldServer extends World implements IAsyncTaskHandler, Callable<WorldServer> {
    ...
    private BlockActionDataList[] S = new BlockActionDataList[]{new BlockActionDataList(null), new BlockActionDataList(null)};
    private int T;
    ...
    public WorldServer call() throws Exception {
        ...
        this.timings.tracker.startTiming(); // Spigot
        this.getTracker().updatePlayers();
        this.timings.tracker.stopTiming(); // Spigot
