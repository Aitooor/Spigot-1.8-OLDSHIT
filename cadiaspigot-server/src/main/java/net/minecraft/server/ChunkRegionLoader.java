...
public class ChunkRegionLoader implements IChunkLoader, IAsyncChunkSaver {
    ...
    private Map<net.minecraft.server.ChunkCoordIntPair, NBTTagCompound> b = new ConcurrentHashMap();
    private Set<net.minecraft.server.ChunkCoordIntPair> c = Collections.newSetFromMap(new ConcurrentHashMap());
    ...
    public boolean chunkExists(World world, int i, int j) {
        net.minecraft.server.ChunkCoordIntPair chunkcoordintpair = new net.minecraft.server.ChunkCoordIntPair(i, j);
    ...
    protected void a(net.minecraft.server.ChunkCoordIntPair chunkcoordintpair, NBTTagCompound nbttagcompound) {
        if (!this.c.contains(chunkcoordintpair)) {
    ...
    public boolean c() {
        if (this.b.isEmpty()) {
            ...
            net.minecraft.server.ChunkCoordIntPair chunkcoordintpair = (net.minecraft.server.ChunkCoordIntPair) this.b.keySet().iterator().next();
    ...
    private void b(net.minecraft.server.ChunkCoordIntPair chunkcoordintpair, NBTTagCompound nbttagcompound) throws IOException {
    ...
    private void a(Chunk chunk, World world, NBTTagCompound nbttagcompound) {
        ...
        net.minecraft.server.ChunkSection[] achunksection = chunk.getSections();
        NBTTagList nbttaglist = new NBTTagList();
        boolean flag = !world.worldProvider.o();
        net.minecraft.server.ChunkSection[] achunksection1 = achunksection;
        int i = achunksection.length;

        NBTTagCompound nbttagcompound1;

        for (int j = 0; j < i; ++j) {
            net.minecraft.server.ChunkSection chunksection = achunksection1[j];
    ...
    private Chunk a(World world, NBTTagCompound nbttagcompound) {
        ...
        byte b0 = 16;
        net.minecraft.server.ChunkSection[] achunksection = new net.minecraft.server.ChunkSection[b0];
        boolean flag = !world.worldProvider.o();

        for (int k = 0; k < nbttaglist.size(); ++k) {
            NBTTagCompound nbttagcompound1 = nbttaglist.get(k);
            byte b1 = nbttagcompound1.getByte("Y");
            net.minecraft.server.ChunkSection chunksection = new net.minecraft.server.ChunkSection(b1 << 4, flag);
