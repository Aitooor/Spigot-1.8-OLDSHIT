...
public class ChunkProviderServer implements IChunkProvider {
    ...
    public net.minecraft.server.Chunk emptyChunk;
    public IChunkProvider chunkProvider;
    private IChunkLoader chunkLoader;
    public boolean forceChunkLoad = false; // CraftBukkit - true -> false
    public LongObjectHashMap<net.minecraft.server.Chunk> chunks = new LongObjectHashMap<net.minecraft.server.Chunk>();
    ...
    public void queueUnload(int i, int j) {
        ...
        net.minecraft.server.Chunk chunk = chunks.get(LongHash.toLong(i, j));
        ...
        if (this.world.worldProvider.e()) {
            if (!this.world.c(i, j)) {
                ...
                net.minecraft.server.Chunk c = chunks.get(LongHash.toLong(i, j));
                if (c != null) {
                    c.mustSave = true;
                }
                // CraftBukkit end
    ...
    public void b() {
        ...
        while (iterator.hasNext()) {
            net.minecraft.server.Chunk chunk = (net.minecraft.server.Chunk) iterator.next();
    ...
    public net.minecraft.server.Chunk getChunkIfLoaded(int x, int z) {
        return chunks.get(LongHash.toLong(x, z));
    }

    public net.minecraft.server.Chunk getChunkAt(int i, int j) {
        return getChunkAt(i, j, null);
    }

    public net.minecraft.server.Chunk getChunkAt(int i, int j, Runnable runnable) {
        unloadQueue.remove(i, j);
        net.minecraft.server.Chunk chunk = chunks.get(LongHash.toLong(i, j));
        net.minecraft.server.ChunkRegionLoader loader = null;

        if (this.chunkLoader instanceof net.minecraft.server.ChunkRegionLoader) {
            loader = (net.minecraft.server.ChunkRegionLoader) this.chunkLoader;
    ...
    public net.minecraft.server.Chunk originalGetChunkAt(int i, int j) {
        this.unloadQueue.remove(i, j);
        net.minecraft.server.Chunk chunk = (net.minecraft.server.Chunk) this.chunks.get(LongHash.toLong(i, j));
        ...
        if (chunk == null) {
            ...
            for (int x = -2; x < 3; x++) {
                for (int z = -2; z < 3; z++) {
                    ...
                    net.minecraft.server.Chunk neighbor = this.getChunkIfLoaded(chunk.locX + x, chunk.locZ + z);
                    if (neighbor != null) {
    ...
    public net.minecraft.server.Chunk loadChunk(int i, int j) {
        if (this.chunkLoader == null) {
            return null;
        } else {
            try {
                net.minecraft.server.Chunk chunk = this.chunkLoader.a(this.world, i, j);
    ...
    public void saveChunkNOP(net.minecraft.server.Chunk chunk) {
        if (this.chunkLoader != null) {
            try {
    ...
    public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
        net.minecraft.server.Chunk chunk = this.getOrCreateChunk(i, j);
    ...
    public boolean a(IChunkProvider ichunkprovider, net.minecraft.server.Chunk chunk, int i, int j) {
        if (this.chunkProvider != null && this.chunkProvider.a(ichunkprovider, chunk, i, j)) {
            net.minecraft.server.Chunk chunk1 = this.getOrCreateChunk(i, j);
    ...
    public boolean unloadChunks() {
        if (!this.world.savingDisabled) {
            ...
            for (int i = 0; i < 100 && !this.unloadQueue.isEmpty(); ++i) {
                ...
                net.minecraft.server.Chunk chunk = this.chunks.get(chunkcoordinates);
