...
public abstract class EntityProjectile extends Entity implements IProjectile {
    ...
    public void t_() {
        ...
        if (this instanceof EntityPotion && this.shooter != null && this.shooter.isSprinting() && ar > 5) {
            double diffX = FastMath.abs(this.shooter.locX - (this.locX + this.motX));
            double diffY = 2.0D - FastMath.abs(this.shooter.locY - (this.locY + this.motY));
            double diffZ = FastMath.abs(this.shooter.locZ - (this.locZ + this.motZ));
