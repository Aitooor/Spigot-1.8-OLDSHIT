...
import online.nasgar.spigot.util.FastRandom;
...
public abstract class Entity implements ICommandListener {
    ...
    public void move(double d0, double d1, double d2) {
        ...
        if (this.noclip) {
            ...
            boolean isSneaking = this.onGround && this.isSneaking() && this instanceof EntityHuman;
            ...
            if (this.s_() && !isSneaking && this.vehicle == null) {
