...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    public static final AttributeKey<Integer> protocolVersion2 = new AttributeKey<Integer>("protocol_version");
    ...
    {
        Integer ver = attr.attr( protocolVersion2 ).get();
    ...
    public void a(Packet packet, GenericFutureListener<? extends Future<? super Void>> genericfuturelistener, GenericFutureListener<? extends Future<? super Void>>... agenericfuturelistener) {
        if (packet instanceof PacketPlayInUseEntity && ((PacketPlayInUseEntity) packet).a() == PacketPlayInUseEntity.EnumEntityUseAction.ATTACK) {
            SpigotConfig.thread.getAsyncHitDetection().addPacket(packet, this, agenericfuturelistener);
            return;
        }
    ...
    private boolean isMovementPacket(Packet packet) {
        if (packet instanceof PacketPlayOutEntityVelocity || packet instanceof PacketPlayOutPosition || packet instanceof PacketPlayInFlying.PacketPlayInPosition || packet instanceof PacketPlayInFlying) return true;
