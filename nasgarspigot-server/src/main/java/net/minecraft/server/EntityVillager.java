...
public class EntityVillager extends EntityAgeable implements IMerchant, NPC {
    ...
    private void cw() {
        IMerchantRecipeOption[][][] aentityvillager_imerchantrecipeoption = EntityVillager.bC[this.getProfession()];
